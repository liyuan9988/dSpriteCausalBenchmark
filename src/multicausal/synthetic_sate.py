...
from src.multicausal.data_class import SATETrainDataSet, SATETestDataSet
...
def generate_test_synthetic_sate() -> SATETestDataSet:
    """
    Returns
    -------
...
def generate_train_synthetic_sate(data_size: int, backdoor_dim: int = 100,
                                  rand_seed: int = 42) -> Tuple[SATETrainDataSet, SATETestDataSet]:
    """
    ...
    train_data = SATETrainDataSet(backdoor_1st=backdoor_1st,
                                  backdoor_2nd=backdoor_2nd,
                                  treatment_1st=treatment_1st,
                                  treatment_2nd=treatment_2nd,
                                  outcome=outcome)

    test_data = generate_test_synthetic_sate()
